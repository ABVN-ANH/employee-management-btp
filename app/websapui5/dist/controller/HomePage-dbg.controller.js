sap.ui.define([
    ...
    return Controller.extend("websapui5.controller.HomePage", {
        ...
        _showFormFragment: function (sFragmentName) {
            ...
            // Ensure app model is always set for fragment binding
            this.getView().setModel(this.getOwnerComponent().getModel("app"), "app");
            // Debug log for userRole
            const userRole = this.getOwnerComponent().getModel("app").getProperty("/userRole");
            console.log("[DEBUG] userRole in app model:", userRole);
